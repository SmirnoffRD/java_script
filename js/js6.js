...
const gallery = {
  settings: {
    ...
    imageNFSrc: 'images/gallery/noimage.jpg',
  },
  ...
  containerClickHandler(event) {
    ...
    // Открываем картинку с полученным из целевого тега (data-full_image_url аттрибут) если она доступна.
    const bigImage = new Image();
    bigImage.onload = () => this.openImage(event.target.dataset.full_image_url);
    bigImage.onerror = () => this.openImage(this.settings.imageNFSrc);
    bigImage.src = event.target.dataset.full_image_url;
  },
